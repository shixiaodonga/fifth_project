...
time.sleep(1)
# 根据文本
Select(driver.find_element_by_css_selector('#province')).select_by_visible_text('江苏省')
# time.sleep(1)
Select(driver.find_element_by_css_selector('#city')).select_by_visible_text('南通市')
# time.sleep(1)
